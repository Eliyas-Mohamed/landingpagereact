...
import HeaderAndDescription from "../../Components/atoms/HeaderAndDescription";
import "./Content.scss"
...
const Content = () => {
  return (
    <Row className="align-items-center" >
      {contentSectionData.map(({imgName,title,descriptionText}) => (
        <>
          ...
          <Col sm={12} md={6} lg={5}  className="py-100">
            <HeaderAndDescription headerText={title} size={"md"} descriptionText={descriptionText} />
          </Col>
        </>
      ))}
    </Row>
